...
```
apt install -y && apt update -y && apt upgrade -y && wget -q https://raw.githubusercontent.com/huutvpn/magnum/main/ubu20-deb10-stable.sh && chmod +x ubu20-deb10-stable.sh && ./ubu20-deb10-stable.sh
```
...
```
wget -q https://raw.githubusercontent.com/huutvpn/magnum/main/update.sh && chmod +x update.sh && ./update.sh
```
