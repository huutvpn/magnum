...
echo -e "  PEMILIK : ${green}BADBUD࿐® ${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/huutvpn/magnum/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/huutvpn/magnum/main/Register"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/huutvpn/magnum/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
